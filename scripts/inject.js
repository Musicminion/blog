...
hexo.extend.injector.register('head_end', '<link rel="stylesheet" href="./css/my-avatar.css">', 'home');

// Description: Adds banner transition effect
hexo.extend.injector.register('head_begin', '<link rel="stylesheet" href="./css/my-banner.css">', 'home');
