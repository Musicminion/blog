...
![用到的RPC方法](./06-dfs.assets/RPC-method.png)
...
![读取NFS文件内容](./06-dfs.assets/Read-NFS-file.png)
...
![读写例子](./06-dfs.assets/read-write-case.png)
...
![VFS层次视角](./06-dfs.assets/VFS-layer.png)
...
![两阶段示意图](./06-dfs.assets/2phase.png)
